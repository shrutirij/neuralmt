...
#            print num_examples
        print datetime.datetime.now()
#            print total_loss/num_examples

        print total_loss/len(self.s_data)
        self.model.save(str(total_loss), [self.l2r_builder, self.r2l_builder, self.dec_builder, self.params["s_lookup"], self.params["t_lookup"], self.params["W_y"], self.params["b_y"], self.params["W1_att"], self.params["W2_att"], self.params["v_att"]])
